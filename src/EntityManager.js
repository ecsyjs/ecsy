...
export class EntityManager {
  ...
  entityAddComponent(entity, Component, values) {
    if (!this.world.componentsManager._ComponentsMap[Component.getTypeId()]) {
      throw new Error(
    ...
    entity._components[Component.getTypeId()] = component;
  ...
  entityRemoveComponent(entity, Component, immediately) {
    ...
    if (immediately) {
      ...
      entity._componentsToRemove[Component.getTypeId()] =
        entity._components[Component.getTypeId()];
      delete entity._components[Component.getTypeId()];
    }
  ...
  _entityRemoveComponentSync(entity, Component, index) {
    ...
    entity._ComponentTypes.splice(index, 1);
    var component = entity._components[Component.getTypeId()];
    delete entity._components[Component.getTypeId()];
    component.dispose();
  ...
  processDeferredRemoval() {
    ...
    for (let i = 0; i < this.entitiesWithComponentsToRemove.length; i++) {
      ...
      while (entity._ComponentTypesToRemove.length > 0) {
        ...
        var component = entity._componentsToRemove[Component.getTypeId()];
        delete entity._componentsToRemove[Component.getTypeId()];
        component.dispose();
        this.world.componentsManager.componentRemovedFromEntity(Component);
