...
export class MovementSystem extends System {
  ...
  execute(delta) {
    let canvasWidth = this.world.getComponent(CanvasContext).width;
    let canvasHeight = this.world.getComponent(CanvasContext).height;
    let multiplier = this.world.getComponent(DemoSettings).speedMultiplier;
...
export class Renderer extends System {
  ...
  execute() {
    let canvasComponent = this.world.getComponent(CanvasContext);
